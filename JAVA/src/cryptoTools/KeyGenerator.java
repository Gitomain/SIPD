...
/**
 * KeyGenerator is able to get Public/ Private keys and 
 * save them in files. Also, it can retrieve the keys 
 * any time.
 * 
...
public class KeyGenerator 
{
	...
	public String PrivateKeyToString(PrivateKey privKey) throws IOException {
		...
		encodedPrivateKey = Tools.encodeBytes(encodedPrivateKey);
